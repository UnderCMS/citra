...
void ConfigureDebug::SetConfiguration() {
    ...
    ui->delay_main_thread_start->setChecked(Settings::values.delay_main_thread_start.GetValue());
...
void ConfigureDebug::ApplyConfiguration() {
    ...
    Settings::values.delay_main_thread_start = ui->delay_main_thread_start->isChecked();
